...
def test_job_manager_filters_by_project(
    ...
    manager = JobManager()
    job_a = manager.create_job(
        target="a.example.com", profile="passive", project="alpha"
    )
    job_b = manager.create_job(
        target="b.example.com", profile="passive", project="beta"
    )
