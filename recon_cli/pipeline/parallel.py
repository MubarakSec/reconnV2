...
class DependencyResolver:
    ...
    STAGE_DEPENDENCIES = {
        ...
        "auth_bypass_tech": {"auth_discovery"},
        "active_auth": {"auth_bypass_tech"},
        "waf_probe": {"active_auth"},
        "waf_bypass": {"waf_probe"},
        "race_condition": {"waf_bypass"},
        "web_cache_vuln": {"race_condition"},
        "idor_probe": {"web_cache_vuln"},
        "auth_matrix": {"idor_probe"},
        "wordlist_miner": {"auth_matrix"},
        "fuzzing": {"wordlist_miner"},
        ...
        "headless_crawl": {"js_intelligence"},
        "api_recon": {"headless_crawl"},

        "graphql_recon": {"api_recon"},
        "graphql_exploit": {"graphql_recon"},
        "api_schema_probe": {"graphql_exploit"},
        "api_reconstructor": {"api_schema_probe"},
        "api_logic_fuzzer": {"api_reconstructor"},
        "oauth_discovery": {"api_logic_fuzzer"},
        "oauth_vuln": {"oauth_discovery"},
        "ws_grpc_discovery": {"oauth_vuln"},
