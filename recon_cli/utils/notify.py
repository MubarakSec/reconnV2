...
def send_telegram_message(
    token: Optional[str], chat_id: Optional[str], text: str, timeout: int = 5
) -> bool:
...
def send_discord_message(
    webhook_url: Optional[str], text: str, timeout: int = 5
) -> bool:
...
def send_pipeline_notification(
    context, status: str, error: Optional[str] = None
) -> None:
