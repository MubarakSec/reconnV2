...
DEFAULT_PROFILES_CONTENT = """{
  ...
  "ultra-deep": {
    ...
    "stages": [
      ...
      "waf_probe", "idor", "auth_matrix", "fuzz", "active_intel", "secrets", 
      "runtime_crawl", "js_intel", "api_recon", "graphql_recon", "graphql_exploit", 
      "api_schema_probe", "oauth_discovery", "ws_grpc_discovery", "param_mining", 
      "html_form_mining", "upload_probe", "vuln_scan", "cms_scan", "rescore", 
      "trim_results", "correlation", "learning", "scanner", "verify_findings", 
      "extended_validation", "idor_validator", "ssrf_validator", 
      "open_redirect_validator", "auth_bypass_validator", 
