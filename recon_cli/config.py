...
DEFAULT_PROFILES_CONTENT = """{
  ...
  "ultra-deep": {
    ...
    "stages": [
      ...
      "secrets", "runtime_crawl", "js_intel", "headless_crawl", "api_recon", 
    ...
    "runtime": {
      ...
      "enable_auth_discovery": true,
      "enable_auth_bypass_tech": true,
      "enable_active_auth": true,
      "enable_js_intel": true,
      "enable_api_recon": true,
      "enable_api_schema_probe": true,
      "enable_api_reconstructor": true,
      "enable_api_logic_fuzzer": true,
      "enable_param_mining": true,
      "enable_html_form_mining": true,
      "enable_waf_probe": true,
      "enable_waf_bypass": true,
      "enable_race_condition": true,
      "enable_cache_vuln": true,
      "enable_takeover": true,
      "enable_dalfox": true,
      "enable_sqlmap": true,
      "enable_nmap": true,
      "enable_fuzz": true,
      "enable_wordlist_miner": true,
      "enable_runtime_crawl": true,
